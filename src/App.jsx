...
function App() {
  ...
  return (
    <>
      <nav className="desktop:w-[70%] desktop:h-[7vw] w-full h-[15vw] flex items-center justify-between desktop:px-0 px-[5vw]">
        <span className="h-fit flex items-center">
          <Menu
            onClick={() => setOpenMenu(true)}
            className="desktop:hidden block w-[3.8vw] aspect-square mr-[4vw] cursor-pointer"
          />
          <div
            className={`desktop:hidden fixed inset-0 bg-Black75 transition-opacity duration-500 ${
              openMenu
          ...
          <Logo className="desktop:w-[10vw] w-[33vw] h-fit desktop:pb-0 pb-[0.8vw]" />
        ...
        <span className="flex items-center desktop:gap-[2.5vw] gap-[5vw]">
          ...
          >
            ...
            <Cart className="cursor-pointer desktop:w-[1.5vw] w-[5vw] h-fit" />
          </div>
          {itemnumbers > 0 && addedcart && !checkout ? (
            <>
              <div
                className={`z-[333] bg-White shadow-2xl transition-all origin-center duration-200 ease-linear desktop:rounded-[0.5vw] rounded-[3vw] absolute desktop:translate-y-[11vw] translate-y-[48vw] desktop:-translate-x-[10vw] desktop:left-auto left-1/2 -translate-x-1/2  desktop:w-[24vw] w-[94%] desktop:h-[17vw] h-[75vw] desktop:pb-[2vw] pb-[7vw]   ${
                  openCart
                    ? "opacity-100 scale-100 pointer-events-auto"
                    : "opacity-0 scale-0 pointer-events-none"
                }`}
              >
                <p className=" font-bold mediumTxt desktop:p-[1.5vw] p-[5vw]">Cart</p>
                <div className="w-full desktop:h-[0.15vw] h-[0.8vw] bg-Light-grayish-blue"></div>
                <div className=" desktop:p-[1.5vw] p-[5vw] flex items-center desktop:gap-[1.5vw] gap-[6vw] mt-[1.5vw]">
                  <img
                  ...
                  />
                  <span>
                    <p className="text-Grayish-blue font-medium smallTxt whitespace-nowrap">
                      Fall Limited Edition Sneakers
                    </p>
                    <div className="flex items-center smallTxt text-Grayish-blue font-medium desktop:gap-[0.25vw] gap-[1vw] desktop:mt-[0.1vw] mt-[0.3vw]">
                      $125.00{" "}
                      <Close className="text-Grayish-blue desktop:w-[0.6vw] w-[2.5vw] aspect-square" />
                      {itemnumbers}{" "}
                      <p className="desktop:ml-[0.25vw] ml-[1.3vw] font-bold text-Dark-grayish-blue">
                        ${itemnumbers * 125}.00
                      </p>
                    </div>
                  </span>
                  <Delete
                    ...
                    className="desktop:w-[1vw] w-[5vw] aspect-square cursor-pointer"
                  />
                </div>
                <div
                  onClick={() => setProcessing(true)}
                  className="cursor-pointer desktop:my-[0.5vw] my-[3vw] w-[90%] desktop:h-[3.5vw] h-[15vw] bg-Orange font-bold flex items-center justify-center desktop:rounded-[0.5vw] rounded-[3vw] smallTxt mx-auto"
                >
                  Checkout
                </div>
              </div>
            ...
            <div
              className={` bg-White z-[999] shadow-2xl transition-all origin-center duration-200 ease-linear desktop:rounded-[0.5vw] rounded-[3vw] absolute desktop:translate-y-[11vw] translate-y-[48vw] desktop:-translate-x-[10vw] desktop:left-auto left-1/2 -translate-x-1/2 desktop:w-[24vw] w-[94%] desktop:h-[17vw] h-[75vw]
            ${
              openCart
                ? "opacity-100 scale-100 pointer-events-auto"
                : "opacity-0 scale-0 pointer-events-none"
            ...
            >
              ...
              <div className=" w-full desktop:h-[12vw] h-[48vw] flex items-center justify-center">
                <p className=" font-bold mediumTxt">Your cart is empty</p>
              </div>
            </div>
          )}
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="desktop:w-[35vw] flex items-center justify-center">
                <span
                  ...
                  className="group absolute left-0 cursor-pointer flex items-center justify-center rounded-full bg-White desktop:w-[3vw] desktop:h-[3vw] z-[100]"
                >
                ...
                <span
                  ...
                  className="group absolute right-0 cursor-pointer flex items-center justify-center rounded-full bg-White desktop:w-[3vw] desktop:h-[3vw] z-[100]"
                >
      ...
      <section className="w-full h-full desktop:px-[18vw] desktop:py-[5vw] flex desktop:flex-row flex-col">
        <section className="desktop:w-[29vw] w-full flex flex-col desktop:gap-[2vw]">
          <div className="bg-Orange desktop:w-[29vw] w-full desktop:aspect-square desktop:rounded-[1vw] overflow-hidden flex items-center justify-between">
          <span
                  onClick={() => {
                    activeIndex > 0 ? setActiveIndex(activeIndex - 1) : "",
                      setSlideDirection("left");
                  }}
                  className="desktop:hidden group absolute left-[4vw] cursor-pointer flex items-center justify-center rounded-full bg-White w-[10vw] h-[10vw] z-[100]"
                >
        ...
        <section className="desktop:p-0 p-[5vw] desktop:w-[33vw] desktop:pl-[7.5vw] flex items-center">
          <div className="w-full h-fit">
            ...
            <span className="flex desktop:flex-col flex-row desktop:items-start items-center justify-between">
              ...
              <span className="bg-Dark-grayish-blue desktop:w-[3vw] w-[13vw] desktop:h-[1.8vw] h-[6.8vw] text-white flex items-center justify-center desktop:rounded-[0.4vw] rounded-[1.5vw] ultraTxt desktop:tracking-normal tracking-[0.3vw]">
                50%
              </span>
              </span>
            <p className="desktop:mt-[0.5vw] mediumTxt line-through text-Dark-grayish-blue font-bold">
              $250.00
            </p>
            </span>
            <div className="flex desktop:flex-row flex-col desktop:gap-[1vw] gap-[4vw] desktop:mt-[2vw] mt-[6vw]">
              <div className="bg-Light-grayish-blue desktop:rounded-[0.5vw] rounded-[3vw] desktop:w-[10vw] w-full desktop:h-[3.3vw] h-[15vw] flex items-center justify-between desktop:px-[1vw] px-[7vw]">
                <Minus
                  onClick={() => {
                    itemnumbers > 0 ? setItemnumbers(itemnumbers - 1) : "",
                      setClick(false);
                  }}
                  className="cursor-pointer desktop:w-[0.8vw] w-[3vw] aspect-square"
                />
              ...
              <div
                ...
                className="cursor-pointer flex items-center justify-center desktop:gap-[1vw] gap-[4vw] desktop:w-[15vw] desktop:h-[3.3vw] h-[15vw] bg-Orange desktop:rounded-[0.5vw] rounded-[3vw] smallTxt font-bold"
              >
                <Cart className="desktop:w-[1vw] w-[5vw] aspect-square" />
                Add to cart
              </div>

              {/* item added to cart pop-up */}
              <div
                className={`transition-all origin-center duration-700 ease-in-out fixed ${
                  click && itemnumbers > 0
                    ? "animate-pop-in top-[2vw]"
                    : "opacity-0 top-[-20vw] scale-0"
                } left-1/2 -translate-x-1/2 whitespace-nowrap w-fit desktop:h-[3.3vw] h-[9vw] desktop:rounded-[0.5vw] rounded-[2vw] bg-White smallTxt desktop:shadow-md desktop:gap-[1vw] gap-[2vw] flex items-center desktop:px-[1.5vw] px-[2.5vw]`}
              >
                <div className="desktop:p-[0.25vw] p-[0.5vw] flex items-center justify-center desktop:w-[1.5vw] w-[5vw] aspect-square bg-Orange rounded-full">
                  <Checkmark className="desktop:w-fit w-[10vw] aspect-square" />
                </div>
                Item added to cart
              </div>
              ...
              <div
                className={`transition-all origin-center duration-700 ease-in-out fixed ${
                  processing
                    ? "animate-pop-in top-[2vw]"
                    : "opacity-0 top-[-20vw] scale-0"
                } left-1/2 -translate-x-1/2 whitespace-nowrap w-fit desktop:h-[3.3vw] desktop:rounded-[0.5vw] bg-White smallTxt desktop:shadow-md desktop:gap-[1vw] flex items-center desktop:px-[1.5vw]`}
              >
                <Spinner />
              ...
              <div
                className={`transition-all origin-center duration-700 ease-in-out fixed ${
                  checkout
                    ? "animate-pop-in top-[2vw]"
                    : "opacity-0 top-[-20vw] scale-0"
                } left-1/2 -translate-x-1/2 w-fit desktop:h-[4vw] desktop:rounded-[0.5vw] bg-White smallTxt desktop:shadow-md desktop:gap-[1vw] flex items-center desktop:px-[1.5vw]`}
              >
                <div className="desktop:p-[0.25vw] flex items-center justify-center desktop:w-[1.5vw] desktop:h-[1.5vw] bg-Orange rounded-full">
                  <Checkmark className="w-fit h-fit" />
                </div>
